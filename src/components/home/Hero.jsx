...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen max-h-screen overflow-hidden z-10 flex flex-col">
      ...
      <div className="relative flex-1 flex items-center justify-center px-3 sm:px-4 lg:px-6 z-30 py-4 sm:py-5 md:py-6 lg:py-8">
        <div className="relative w-full max-w-6xl">
          ...
          <motion.div 
            ...
            className="text-center space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-5"
          >
            {/* Enhanced Badge */}
            <motion.div 
              ...
              className="inline-flex items-center gap-1 sm:gap-1.5 bg-gradient-to-r from-yellow-600/30 to-yellow-500/20 backdrop-blur-md px-2 sm:px-3 md:px-3.5 py-1 sm:py-1.5 rounded-full border-2 border-yellow-500/50 shadow-lg"
            >
              <motion.div
            ...
            <motion.h1 
              ...
              className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl !leading-tight font-extrabold text-white drop-shadow-2xl px-2"
            >
              Excel in Your{" "}
              <motion.span 
              ...
              <br />
              <span className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl">with Professional Training</span>
            </motion.h1>
            ...
            <motion.p 
              ...
              className="text-xs sm:text-sm md:text-base lg:text-lg text-white/90 max-w-3xl mx-auto font-medium leading-relaxed drop-shadow-lg px-3"
            >
            ...
            <motion.div 
              ...
              className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 pt-1 sm:pt-1.5 md:pt-2"
            >
              <Link href="/courses">
                <motion.button 
                  whileHover={{ scale: 1.05, boxShadow: "0 20px 40px rgba(234, 179, 8, 0.4)" }}
                  whileTap={{ scale: 0.95 }}
                  className="group relative bg-gradient-to-r from-yellow-600 via-yellow-500 to-yellow-600 text-blue-950 px-4 sm:px-5 md:px-6 lg:px-8 py-2 sm:py-2.5 md:py-3 rounded-lg font-bold text-xs sm:text-sm md:text-base hover:shadow-2xl transition-all duration-300 flex items-center gap-1.5 sm:gap-2 overflow-hidden cursor-pointer"
                >
                  ...
                  <Ship className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 relative z-10 group-hover:rotate-12 transition-transform" />
                  <span className="relative z-10">Explore Courses</span>
                  <ArrowRight className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 relative z-10 group-hover:translate-x-2 transition-transform" />
                </motion.button>
              </Link>
              <Link href="/courses">
                <motion.button 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group relative border-2 border-yellow-500 bg-yellow-500/10 backdrop-blur-md text-yellow-400 px-4 sm:px-5 md:px-6 lg:px-8 py-2 sm:py-2.5 md:py-3 rounded-lg font-bold text-xs sm:text-sm md:text-base hover:bg-yellow-500/20 hover:border-yellow-400 transition-all duration-300 flex items-center gap-1.5 sm:gap-2 shadow-lg cursor-pointer"
                >
                  <Play className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 group-hover:scale-125 transition-transform" />
