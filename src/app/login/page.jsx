        ...
        >
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full inline-flex justify-center py-2 px-4 border border-white/30 rounded-xl shadow-sm bg-white/5 text-white hover:bg-white/10 transition-all">
